...
//  WappfyBird
//
//  Created by Javier Quero Ojeda on 27/10/15.
//  Copyright (c) 2015 Javier Quero Ojeda. All rights reserved.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMoveToView(view: SKView) {
        ...
        let birdTexture4 = SKTexture(imageNamed: "bird4")
        birdTexture4.filteringMode = .Nearest
        let anim = SKAction.animateWithTextures([birdTexture1, birdTexture2, birdTexture3, birdTexture4], timePerFrame: 0.2)
